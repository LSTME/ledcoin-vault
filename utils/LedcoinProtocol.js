...
console.log('SetBalance(AddLedcoin, 255):', LP.SetBalance(LP.OperationType.AddLedcoin, 255));
console.log('SetBalance(DeduceLedcoin, 255):', LP.SetBalance(LP.OperationType.DeduceLedcoin, 255));
